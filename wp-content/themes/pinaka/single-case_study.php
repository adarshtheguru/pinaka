        ...
        <div class="container">
            <div class="contBox">
                ...
                <div class="right">
                    ...
                    <svg class="animatedThread" viewBox="0 0 500 682" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.14718 1V593.5C0.176668 617.345 3.42417 654.729 28.6472 655H457.647C473.732 654.346 501 658.5 498.647 681.5" stroke="#003E63" stroke-linecap="round"/>
                    </svg>
                </div>
            </div>
        </div>
